...
class UserCommands(commands.Cog):
    ...
    @commands.slash_command(name="лизнуть", description="👅 Лизнуть друга")
    ...
    @commands.slash_command(name="фурсона", description="🎭 Сгенерировать случайную фурсону")
    ...
    @commands.slash_command(name="уйти", description="🚪 Объявить, что вы отходите")
    ...
    @commands.slash_command(name="утешить", description="🤗 Утешить друга")
    ...
    @commands.slash_command(name="таро", description="🔮 Вытянуть карту Таро")
    ...
    @commands.slash_command(name="посоветовать", description="🎱 Задать вопрос и получить ответ")
    ...
    @commands.slash_command(name="работа", description="💼 Симуляция работы (шутка)")
    async def work(self, inter: disnake.ApplicationCommandInteraction):
        jobs = [
            ("тестировщиком подушек", "пару пушистых монеток"),
            ("выгульщиком облаков", "вдохновение и печеньку"),
            ("собирателем радуги", "горсть конфетти"),
            ("хранителем уюта", "благодарность и поглаживание"),
            ("певцом ночи", "звезду с неба"),
        ]
        job, reward = random.choice(jobs)
        responses = [
            f"{inter.author.mention} устроился {job} и заработал {reward}! 💰",
            f"{inter.author.mention} сегодня работал {job} и получил {reward}. Хороший денёк!",
            f"{inter.author.mention} подрабатывает {job} — заслужил {reward}. Так держать!",
        ]
        await inter.response.send_message(random.choice(responses))

    @commands.slash_command(name="покормить", description="🍲 Покормить участника")
    ...
    @commands.slash_command(name="подарок", description="🎁 Сделать случайный подарок участнику")
    ...
    @commands.slash_command(name="бип", description="📡 Проверить задержку бота")
    ...
    @commands.slash_command(name="погода", description="☀️ Погода в фурри-городке")
    ...
    @commands.slash_command(name="лакомство", description="🍪 Угостить себя или друга")
